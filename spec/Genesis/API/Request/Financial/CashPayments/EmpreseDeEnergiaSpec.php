...
use Genesis\API\Request\Financial\CashPayments\EmpreseDeEnergia;
use PhpSpec\ObjectBehavior;
use spec\SharedExamples\Genesis\API\Request\RequestExamples;

class EmpreseDeEnergiaSpec extends ObjectBehavior
{
    use RequestExamples;

    public function it_is_initializable()
    {
        $this->shouldHaveType(EmpreseDeEnergia::class);
    }
