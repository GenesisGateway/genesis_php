...
use Genesis\API\Request\NonFinancial\Fx\GetTier;
use Genesis\Builder;
use PhpSpec\ObjectBehavior;

class GetTierSpec extends ObjectBehavior
{
    public function it_is_initializable()
    {
        $this->shouldHaveType(GetTier::class);
    }
    ...
    public function it_should_build_correct_url()
    {
        ...
        $this->getApiConfig('url')->shouldBe('https://staging.gate.emerchantpay.net:443/v1/fx/tiers/88');
    }

    public function it_should_have_correct_request_method()
    {
        $this->getConfig()->shouldHaveKeyWithValue('type', 'GET');
    }
