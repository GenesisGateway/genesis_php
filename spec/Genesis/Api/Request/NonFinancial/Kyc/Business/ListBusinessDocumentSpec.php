...
use Genesis\Api\Request\NonFinancial\Kyc\Business\ListBusinessDocument;
use Genesis\Config;
use PhpSpec\ObjectBehavior;
use spec\SharedExamples\Faker;
use spec\SharedExamples\Genesis\Api\Request\RequestExamples;

class ListBusinessDocumentSpec extends ObjectBehavior
{
    use RequestExamples;

    public function it_is_initializable()
    {
        $this->shouldHaveType(ListBusinessDocument::class);
    }
    ...
    public function it_should_set_correct_url()
    {
        ...
        $this->getApiConfig('url')->shouldBe(
            "https://staging.kyc.emerchantpay.net:443/api/v1/businesses/{$businessId}/documents"
        );
    }
