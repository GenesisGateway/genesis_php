...
use Genesis\Api\Request\NonFinancial\Payee\Owners\DissociateOwners;
use Genesis\Builder;
use Genesis\Config;
use PhpSpec\ObjectBehavior;
use spec\SharedExamples\Genesis\API\Request\RequestExamples;

class DissociateOwnersSpec extends ObjectBehavior
{
    use RequestExamples;
    ...
    {
        $this->shouldHaveType(DissociateOwners::class);
        $this->shouldBeAnInstanceOf(BaseRequest::class);
    }

    public function it_should_fail_when_missing_required_parameter()
    {
        $this->testMissingRequiredParameters(['owner_unique_id', 'owners_unique_ids']);
    }
